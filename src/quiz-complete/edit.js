	...
	return (
		<div { ...blockProps }>
			...
			<div className="hmquiz-editor__complete-label">
				<span className="hmquiz-editor__complete-badge">🎉 Completion Screen</span>
				{ enabled
					? ' — shown after all questions are answered'
					: ' — disabled (toggle ON in the ⚙ Settings panel on the right)' }
			</div>

			<div className={ `hmquiz-editor__complete-inner${ enabled ? '' : ' hmquiz-editor__complete-inner--disabled' }` }>
				<InnerBlocks
					template={ [
						[ 'core/heading', { level: 2, content: '🎉 Quiz Complete!' } ],
