...
export default function Edit( { attributes, setAttributes } ) {
	...
	const blockProps = useBlockProps( {
		className: `hmquiz-editor__complete${
			enabled ? '' : ' hmquiz-editor__complete--disabled'
		}`,
		style: editorStyle,
	} );
	...
	return (
		<div { ...blockProps }>
			...
			<div
				className={ `hmquiz-editor__complete-inner${
					enabled ? '' : ' hmquiz-editor__complete-inner--disabled'
				}` }
			>
				<InnerBlocks
					template={ [
