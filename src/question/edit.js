	...
	return (
		<div { ...blockProps }>
			...
			<div className="hmquiz-editor__inner-section">
				<div className="hmquiz-editor__section-label">🖼 Question Content & Answer Feedback</div>
					...
					return (
						...
						>
							<input
								...
								checked={ isCorrect }
								onChange={ () => setAttributes( { correctAnswer: alt.id } ) }
							/>
							<input
								type="text"
								...
								onChange={ ( e ) => updateText( alt.id, e.target.value ) }
							/>
							{ isCorrect && (
								<span className="hmquiz-editor__alt-correct-badge">✓ Correct</span>
							) }
							<Button
								icon="arrow-up-alt2"
								isSmall={ true }
